return {
    components = {
        clickable = {width = 45, height = 90, offset_x = 40, offset_y = 40},
        animation = {
            clips = {
        ...
        script = {path = "./assets/scripts/uiScripts/scr_reload_shell.lua"},
        sprite    = {assetId = "reload_shell", width = 60, height = 85, src_rect = {x = 0, y = 0}, z_index = 3000, pivot = {x = 0, y = 0}, flip = false, is_ui = true, is_unlit = true},
